...
excerpt: "I wrote this post to give back some of the insights I've discovered on my journey to becoming an OSCP. It will cover personal insights, resources, and best practices. There is *a lot* of great information available on the Internet so I will make an honest effort not to sound like a broken record."
date: 2019-04-12
classes: wide
categories: [security]
...
### HackTheBox
Another invaluable resource to go along side of [ippsec's videos](https://www.youtube.com/channel/UCa6eh7gCkpPo5XXUDfygQQA/videos) is [HackTheBox](https://www.hackthebox.eu/). I purchased a VIP membership for about 6 months prior to PWK and spent time attacking their boxes and doing various challenges. *This is extremely useful.* It's true that some of the machines are unlike the PWK network because HTB can be kind of CTF-oriented and/or out-of-scope within the [PWK](https://www.offensive-security.com/information-security-training/penetration-testing-training-kali-linux/) material, but that does not matter in my opinion. Working within the Kali environment, learning the tools and developing a solid pen-testing methodology is what matters here.

<sub>**Note**:  I did not use [VulnHub](https://www.vulnhub.com/), but I [read](https://www.abatchy.com/2017/02/oscp-like-vulnhub-vms) that some of the machines are similar to exploiting some of the PWK Lab machines.</sub>
...
[Linux Privilege Escalation by Guifre Ruiz](https://guif.re/linuxeop) <br />
[GTFOBins Project](https://gtfobins.github.io/)

### Windows
[Windows Privilege Escalation Fundamentals by FuzzySecurity](http://www.fuzzysecurity.com/tutorials/16.html)<br />
[Windows Privilege EoP by Guifre Ruiz](https://guif.re/windowseop) <br />
[Windows Privilege Escalation Guide by Absolomb](https://www.absolomb.com/2018-01-26-Windows-Privilege-Escalation-Guide/)<br />
[LOLBAS Project](https://lolbas-project.github.io/#)

### Pentesting
[The Magic of Learning](https://bitvijays.github.io/index.html)<br />
...
[Mona.py - The Manual by Corelanc0d3r](https://www.corelan.be/index.php/2011/07/14/mona-py-the-manual/)

### OSCP Specific Guides
[Passing OSCP by Scund00r](https://scund00r.com/all/oscp/2018/02/25/passing-oscp.html)<br />
[OSCP: RFI and LFI by Awakened](https://awakened1712.github.io/oscp/oscp-lfi-rfi/)<br />
[OSCP: Transfer Files from Kali to the Target Machine by Awakened](https://awakened1712.github.io/oscp/oscp-transfer-files/)<br />
[Total OSCP Guide by Sushant747](https://sushant747.gitbooks.io/total-oscp-guide/)<br />
...
I recorded the entire exam with [OBS](https://obsproject.com/), following the advice of many. This was *very* useful, as I missed a couple screenshots that I thought were useful for the report. 
